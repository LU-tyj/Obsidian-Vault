---
title: "Unity面试题（包含答案）"
source: "https://zhuanlan.zhihu.com/p/61925255"
author:
  - "[[siki老师]]"
published:
created: 2026-07-03
description: "这个是我刚刚整理出的Unity面试题，为了帮助大家面试，同时帮助大家更好地复习Unity知识点，如果大家发现有什么错误，（包括错别字和知识点），或者发现哪里描述的不清晰，请在下面留言，我会重新更新，希望大家共…"
tags:
  - "clippings"
---
[收录于 · unity游戏开发之路](https://www.zhihu.com/column/c_1563549131259502593)

460 人赞同了该文章

这个是我刚刚整理出的Unity面试题，为了帮助大家面试，同时帮助大家更好地复习Unity知识点，如果大家发现有什么错误，（包括错别字和知识点），或者发现哪里描述的不清晰，请在下面留言，我会重新更新，希望大家共同来帮助开发者

一：什么是 [协同程序](https://zhida.zhihu.com/search?content_id=101890504&content_type=Article&match_order=1&q=%E5%8D%8F%E5%90%8C%E7%A8%8B%E5%BA%8F&zhida_source=entity) ？

在主线程运行的同时开启另一段逻辑处理，来协助当前程序的执行，协程很像多线程，但是不是多线程，Unity的协程实在每帧结束之后去检测yield的条件是否满足。

二：Unity3d中的碰撞器和 [触发器](https://zhida.zhihu.com/search?content_id=101890504&content_type=Article&match_order=1&q=%E8%A7%A6%E5%8F%91%E5%99%A8&zhida_source=entity) 的区别？
...
四：请简述 [ArrayList](https://zhida.zhihu.com/search?content_id=101890504&content_type=Article&match_order=1&q=ArrayList&zhida_source=entity) 和List的主要区别？
...
六： [OnEnable](https://zhida.zhihu.com/search?content_id=101890504&content_type=Article&match_order=1&q=OnEnable&zhida_source=entity) 、Awake、Start运行时的发生顺序？哪些可能在同一个对象周期中反复的发生

Awake –>OnEnable->Start，OnEnable在同一周期中可以反复地发生。

七： [MeshRender](https://zhida.zhihu.com/search?content_id=101890504&content_type=Article&match_order=1&q=MeshRender&zhida_source=entity) 中material和sharedmaterial的区别？

修改 [sharedMaterial](https://zhida.zhihu.com/search?content_id=101890504&content_type=Article&match_order=1&q=sharedMaterial&zhida_source=entity) 将改变所有物体使用这个材质的外观，并且也改变储存在工程里的材质设置。不推荐修改由sharedMaterial返回的材质。如果你想修改渲染器的材质，使用material替代。

八：Unity提供了几种光源，分别是什么

四种。

平行光： [Directional Light](https://zhida.zhihu.com/search?content_id=101890504&content_type=Article&match_order=1&q=Directional+Light&zhida_source=entity)

点光源： [Point Light](https://zhida.zhihu.com/search?content_id=101890504&content_type=Article&match_order=1&q=Point+Light&zhida_source=entity)

聚光灯： [Spot Light](https://zhida.zhihu.com/search?content_id=101890504&content_type=Article&match_order=1&q=Spot+Light&zhida_source=entity)

区域光源： [Area Light](https://zhida.zhihu.com/search?content_id=101890504&content_type=Article&match_order=1&q=Area+Light&zhida_source=entity)
...
十一：简述 [prefab](https://zhida.zhihu.com/search?content_id=101890504&content_type=Article&match_order=1&q=prefab&zhida_source=entity) 的用处

在游戏运行时实例化，prefab相当于一个模板，对你已经有的素材、脚本、参数做一个默认的配置，以便于以后的修改，同时prefab打包的内容简化了导出的操作，便于团队的交流。

十二：请简述 [sealed关键字](https://zhida.zhihu.com/search?content_id=101890504&content_type=Article&match_order=1&q=sealed%E5%85%B3%E9%94%AE%E5%AD%97&zhida_source=entity) 用在类声明时与函数声明时的作用

sealed修饰的类为密封类，类声明时可防止其他类继承此类，在方法中声明则可防止派生类重写此方法。

十三：请简述private，public， [protected](https://zhida.zhihu.com/search?content_id=101890504&content_type=Article&match_order=1&q=protected&zhida_source=entity) ，internal的区别
...
十九：Unity3d提供了一个用于保存和读取数据的类([PlayerPrefs](https://zhida.zhihu.com/search?content_id=101890504&content_type=Article&match_order=1&q=PlayerPrefs&zhida_source=entity))，请列出保存和读取整形数据的函数

PlayerPrefs.SetInt() PlayerPrefs.GetInt()

二十：Unity3d脚本从唤醒到销毁有着一套比较完整的生命周期，请列出系统自带的几个重要的方法。

Awake——>OnEnable–>Start——>Update——> [FixedUpdate](https://zhida.zhihu.com/search?content_id=101890504&content_type=Article&match_order=1&q=FixedUpdate&zhida_source=entity) ——>LateUpdate——>OnGUI——>OnDisable——>OnDestroy
...
三十四：什么是 [LightMap](https://zhida.zhihu.com/search?content_id=101890504&content_type=Article&match_order=1&q=LightMap&zhida_source=entity) ？
...
原文链接： [blog.csdn.net/qq\_349376](https://link.zhihu.com/?target=https%3A//blog.csdn.net/qq_34937637/article/details/79653525)

编辑于 2022-09-01 11:23[游戏开发](https://www.zhihu.com/topic/19553361)
